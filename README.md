# MODEL1310110017: MODEL1310110017
...
`pip install git+https://github.com/biomodels/MODEL1310110017.git`

To install a specific version (in this example, from the 2014-09-16 BioModels release)

`pip install git+https://github.com/biomodels/MODEL1310110017.git@20140916`

## Usage

Importing the model package.

`import MODEL1310110017 as model`
...
The model of uterus post menopause cells in endometrial stroma metabolism is
derived from the community-driven global reconstruction of human metabolism
(version 2.02,
...
and identified by:
[MODEL1310110017](http://identifiers.org/biomodels.db/MODEL1310110017) .
